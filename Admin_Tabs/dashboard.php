...
<a href="?tab=pending_users" class="<?= $tab=='pending_users'?'active':'' ?>">
User Approval
</a>
...
<a href="?tab=library" class="<?= $tab=='library'?'active':'' ?>">
Tree Library
</a>
...
<a class='btn approve'
href='?tab=pending_users&action=approve&id={$u['user_id']}'>
Approve
</a>

<a class='btn reject'
href='?tab=pending_users&action=reject&id={$u['user_id']}'>
Reject
</a>
...
<a class='btn edit'
href='?tab=users&action=edit&id={$u['user_id']}'>
Edit
</a>

<a class='btn delete'
onclick=\"return confirm('Delete this user?')\"
href='?tab=users&action=delete&id={$u['user_id']}'>
Delete
</a>
...
<a class='btn edit'
href='?tab=edit_tree&id={$t['tree_id']}'>
Edit
</a>
...
$stmt = $conn->prepare("SELECT * FROM TREE_SUBMISSIONS WHERE tree_id=?");
...
SET location_name=?,species_id=?
WHERE tree_id=?
")->execute([$location,$species_id,$id]);
...
value='{$tree['location_name']}' required><br><br>
